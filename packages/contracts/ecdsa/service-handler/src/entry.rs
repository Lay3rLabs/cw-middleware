...
use crate::state;
use cw_wavs_ecdsa_api::service_handler::{
    EcdsaServiceHandlerQueryMessages, ExecuteMsg, InstantiateMsg, QueryMsg, TriggerMessageResponse,
};
    ...
    match msg {
        ExecuteMsg::Wavs(msg) => match msg {
            ServiceHandlerExecuteMessages::WavsHandleSignedEnvelope {
                ...
                // Delegate validation to the ECDSA service-manager. Any
...
pub fn query(deps: Deps, _env: Env, msg: QueryMsg) -> StdResult<QueryResponse> {
    match msg {
        ...
        QueryMsg::Ecdsa(msg) => match msg {
            EcdsaServiceHandlerQueryMessages::TriggerValidated { trigger_id } => {
