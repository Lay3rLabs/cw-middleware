use crate::prelude::{
    WavsBasicQueryClientExt, WavsExecClientExt, WavsQueryClientExt, WavsServiceHandlerAddrExt,
};
...
pub trait WavsMockQueryClientExt: WavsQueryClientExt {
    async fn get_service_handler_trigger_message(
        ...
        self.service_handler()
            .basic_contract_query(
                &addr,
                &mock_api::service_handler::QueryMsg::TriggerMessage { trigger_id },
            )
            .await
    }
}
